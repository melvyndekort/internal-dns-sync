"""Sync internal DNS entries to PiHole via API."""
...
def sync_pihole(pihole_config, desired_hosts, desired_cnames):
    """Sync one PiHole's DNS hosts/CNAMEs to the desired state, return change count."""
...
def main():
    """Clone the DNS config repo and sync it to every configured PiHole."""
